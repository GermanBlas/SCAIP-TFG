...
public class SCAIPConstruct {
    ...
    public SCAIPConstruct(Integer version, Integer controller_id, Integer device_type, Schema schema){
    ...
    public String argumentoGeneral(String argumento){
        ...
        switch (argumento){
            case "ref":
                ...
                break;
            case "ver" :
                argumentoGeneral = String.valueOf(version);
                break;
            case "cid":
                argumentoGeneral = String.valueOf(controller_id);
                break;
            case "dty":
                argumentoGeneral = String.valueOf(device_type);
            case "lge":
